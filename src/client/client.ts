...
export class StarpeaceClient implements ClientHandlerContext {
  ...
  constructor() {
    ...
    const callbacks: Partial<ClientCallbacks> = {
      ...
      onReadWorkerCounts: (x, y, kinds) => buildingActionHandler.requestWorkerCounts(this, x, y, kinds),
      ...
      onRequestServiceFigures: (x, y, serviceIndex) => buildingActionHandler.requestServiceFigures(this, x, y, serviceIndex),
      onRequestBankLoan: (x, y, amount) => buildingActionHandler.requestBankLoan(this, x, y, amount),
