...
export interface GameSettings {
  ...
  languageId: string;
  /** Legacy 'AnimateBuildings', default on — OptionsHandlerViewer.pas:510, Map.pas:920. */
  buildingAnimations: boolean;
  /** Legacy 'TransparentOverlays', default on — OptionsHandlerViewer.pas:513, FiveControl.pas:272. */
