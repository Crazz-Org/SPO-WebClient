...
export class IsometricMapRenderer {
  ...
  /** Legacy 'UseTransparency' (Map.pas:1415-1416, :5979): master on/off for fading every building
   *  whose owner differs from the *selected* building's owner (Map.pas:1405-1406 — no selection,
   *  nothing fades). */
  private glassForeignBuildings: boolean = true;
  /** The player's own tycoon id, 0 until login supplies one — feeds only the losing-facilities
   *  reddening below, not the fade. */
  ...
  /** The game store's decimal tycoon id; '' / undefined / unparsable means "unknown" and feeds only
   *  the losing-facilities reddening (see :3598) — glassing keys off the selected building instead. */
