...
export class IsometricMapRenderer {
   ...
   * owner differs from the *selected* building's owner — the comparand is the clicked building's
   * owner (Map.pas:5979), and the whole block is gated on a selection existing (Map.pas:1405-1406),
   * so nothing selected fades nothing.
   */
