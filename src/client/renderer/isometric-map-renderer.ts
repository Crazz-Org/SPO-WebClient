...
export class IsometricMapRenderer {
   ...
   * clicked building's owner, not the local player); no selection ⇒ nothing fades (Map.pas:1405-1406).
   */
  private glassForeignBuildings: boolean = true;
  /** The player's own tycoon id, 0 until login supplies one — now feeds only the losing-facilities reddening below. */
