...
public async switchCompany(company: CompanyInfo): Promise<void> {
  ...
  public async postNewspaperColumn(target: NewspaperTarget, subject: string, body: string, replyToPath?: string, ratings?: NewspaperRatingChoice[]): Promise<{ success: boolean; message: string; board: NewspaperBoard | null }> {
