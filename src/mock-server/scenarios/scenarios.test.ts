...
describe('scenario registry', () => {
  it('SCENARIO_NAMES has 34 entries', () => {
    ...
    // 22: `connection-reachability`, issue 584.
    // 23: `auto-buy`, issue 554.
    ...
    // 32: channel-password, issue 618.
    // 33: create-channel, issue 619.
    // 34: `refresh-season`, issue 588.
    expect(SCENARIO_NAMES).toHaveLength(34);
  });
